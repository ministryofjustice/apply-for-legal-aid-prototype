...
describe('extensions', () => {
  ...
  describe('getAppViews', () => {
    ...
    it('should also output moj-frontend nunjucks paths after it is installed', () => {
      mockExtensionConfig('moj-frontend', {
        nunjucksPaths: [
          '/my-components',
          '/my-layouts'
        ]
      ...
      expect(extensions.getAppViews()).toEqual(joinPaths([
        'node_modules/moj-frontend/my-layouts',
        'node_modules/moj-frontend/my-components',
        'node_modules/govuk-frontend'
      ]))
    })
